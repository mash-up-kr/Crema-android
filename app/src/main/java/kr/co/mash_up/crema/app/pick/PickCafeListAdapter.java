package kr.co.mash_up.crema.app.pick;
...
public class PickCafeListAdapter extends RecyclerView.Adapter<PickCafeListAdapter.ViewHolder>{
    ...
    public PickCafeListAdapter(List<CafeModel> items, Context mContext)
    {
        mItems = items;
        context = mContext;
    }

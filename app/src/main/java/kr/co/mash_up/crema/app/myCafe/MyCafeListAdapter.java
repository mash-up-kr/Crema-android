...
public class MyCafeListAdapter extends RecyclerView.Adapter<MyCafeListAdapter.ViewHolder>{
    ...
    public MyCafeListAdapter(List<CafeModel> items, Context mContext)
    {
        mItems = items;
        context = mContext;
    }

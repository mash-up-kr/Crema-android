...
/**
 * Created by bigstark on 2017. 2. 8..
 */

public class Defines {

    public static final String GOOGLE_API_KEY = "AIzaSyCPAq3TK8qJU2xTz_fE_NBhs4Oh7CVCJLo";
    ...
    public static final int REQUEST_SEARCH_REGION = 1000;
